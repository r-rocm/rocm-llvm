...
; CHECK-NEXT:    buffer_store_dword v3, v25, s[8:11], 0 offen offset:124
; CHECK-NEXT:    buffer_store_dword v2, v25, s[8:11], 0 offen offset:120
; CHECK-NEXT:    buffer_store_dword v1, v25, s[8:11], 0 offen offset:116
; CHECK-NEXT:    buffer_store_dword v0, v25, s[8:11], 0 offen offset:112
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v24, s[0:1] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(9)
; CHECK-NEXT:    buffer_store_dword v7, v25, s[8:11], 0 offen offset:108
; CHECK-NEXT:    buffer_store_dword v6, v25, s[8:11], 0 offen offset:104
; CHECK-NEXT:    buffer_store_dword v5, v25, s[8:11], 0 offen offset:100
; CHECK-NEXT:    buffer_store_dword v4, v25, s[8:11], 0 offen offset:96
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v24, s[0:1]
; CHECK-NEXT:    s_waitcnt vmcnt(13)
; CHECK-NEXT:    buffer_store_dword v11, v25, s[8:11], 0 offen offset:92
; CHECK-NEXT:    buffer_store_dword v10, v25, s[8:11], 0 offen offset:88
; CHECK-NEXT:    buffer_store_dword v9, v25, s[8:11], 0 offen offset:84
; CHECK-NEXT:    buffer_store_dword v8, v25, s[8:11], 0 offen offset:80
; CHECK-NEXT:    s_waitcnt vmcnt(16)
; CHECK-NEXT:    buffer_store_dword v15, v25, s[8:11], 0 offen offset:76
; CHECK-NEXT:    buffer_store_dword v14, v25, s[8:11], 0 offen offset:72
; CHECK-NEXT:    buffer_store_dword v13, v25, s[8:11], 0 offen offset:68
; CHECK-NEXT:    buffer_store_dword v12, v25, s[8:11], 0 offen offset:64
; CHECK-NEXT:    s_waitcnt vmcnt(19)
; CHECK-NEXT:    buffer_store_dword v19, v25, s[8:11], 0 offen offset:60
; CHECK-NEXT:    buffer_store_dword v18, v25, s[8:11], 0 offen offset:56
; CHECK-NEXT:    buffer_store_dword v17, v25, s[8:11], 0 offen offset:52
; CHECK-NEXT:    buffer_store_dword v16, v25, s[8:11], 0 offen offset:48
; CHECK-NEXT:    s_waitcnt vmcnt(22)
; CHECK-NEXT:    buffer_store_dword v23, v25, s[8:11], 0 offen offset:44
; CHECK-NEXT:    buffer_store_dword v22, v25, s[8:11], 0 offen offset:40
; CHECK-NEXT:    buffer_store_dword v21, v25, s[8:11], 0 offen offset:36
; CHECK-NEXT:    buffer_store_dword v20, v25, s[8:11], 0 offen offset:32
; CHECK-NEXT:    s_waitcnt vmcnt(21)
; CHECK-NEXT:    buffer_store_dword v3, v25, s[8:11], 0 offen offset:28
; CHECK-NEXT:    buffer_store_dword v2, v25, s[8:11], 0 offen offset:24
; CHECK-NEXT:    buffer_store_dword v1, v25, s[8:11], 0 offen offset:20
; CHECK-NEXT:    buffer_store_dword v0, v25, s[8:11], 0 offen offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(20)
; CHECK-NEXT:    buffer_store_dword v7, v25, s[8:11], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v6, v25, s[8:11], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v5, v25, s[8:11], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v4, v25, s[8:11], 0 offen
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    buffer_load_dword v3, v26, s[8:11], 0 offen offset:124
; CHECK-NEXT:    buffer_load_dword v2, v26, s[8:11], 0 offen offset:120
; CHECK-NEXT:    buffer_load_dword v1, v26, s[8:11], 0 offen offset:116
; CHECK-NEXT:    buffer_load_dword v0, v26, s[8:11], 0 offen offset:112
; CHECK-NEXT:    buffer_load_dword v7, v26, s[8:11], 0 offen offset:108
; CHECK-NEXT:    buffer_load_dword v6, v26, s[8:11], 0 offen offset:104
; CHECK-NEXT:    buffer_load_dword v5, v26, s[8:11], 0 offen offset:100
; CHECK-NEXT:    buffer_load_dword v4, v26, s[8:11], 0 offen offset:96
; CHECK-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; CHECK-NEXT:    buffer_load_dword v8, v26, s[8:11], 0 offen offset:16
; CHECK-NEXT:    buffer_load_dword v9, v26, s[8:11], 0 offen offset:20
; CHECK-NEXT:    buffer_load_dword v10, v26, s[8:11], 0 offen offset:24
; CHECK-NEXT:    buffer_load_dword v11, v26, s[8:11], 0 offen offset:28
; CHECK-NEXT:    buffer_load_dword v12, v26, s[8:11], 0 offen offset:32
; CHECK-NEXT:    buffer_load_dword v13, v26, s[8:11], 0 offen offset:36
; CHECK-NEXT:    buffer_load_dword v14, v26, s[8:11], 0 offen offset:40
; CHECK-NEXT:    buffer_load_dword v15, v26, s[8:11], 0 offen offset:44
; CHECK-NEXT:    buffer_load_dword v16, v26, s[8:11], 0 offen offset:48
; CHECK-NEXT:    buffer_load_dword v17, v26, s[8:11], 0 offen offset:52
; CHECK-NEXT:    buffer_load_dword v18, v26, s[8:11], 0 offen offset:56
; CHECK-NEXT:    buffer_load_dword v19, v26, s[8:11], 0 offen offset:60
; CHECK-NEXT:    buffer_load_dword v23, v26, s[8:11], 0 offen offset:92
; CHECK-NEXT:    buffer_load_dword v22, v26, s[8:11], 0 offen offset:88
; CHECK-NEXT:    buffer_load_dword v21, v26, s[8:11], 0 offen offset:84
; CHECK-NEXT:    buffer_load_dword v20, v26, s[8:11], 0 offen offset:80
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v25, s1
; CHECK-NEXT:    v_mov_b32_e32 v24, s0
; CHECK-NEXT:    s_waitcnt vmcnt(20)
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[0:3] offset:112
; CHECK-NEXT:    buffer_load_dword v3, v26, s[8:11], 0 offen offset:76
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    buffer_load_dword v2, v26, s[8:11], 0 offen offset:72
; CHECK-NEXT:    buffer_load_dword v1, v26, s[8:11], 0 offen offset:68
; CHECK-NEXT:    buffer_load_dword v0, v26, s[8:11], 0 offen offset:64
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[4:7] offset:96
; CHECK-NEXT:    buffer_load_dword v4, v26, s[8:11], 0 offen
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    buffer_load_dword v5, v26, s[8:11], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v6, v26, s[8:11], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v7, v26, s[8:11], 0 offen offset:12
; CHECK-NEXT:    s_nop 0
