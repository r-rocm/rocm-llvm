...
; W64-O0-NEXT:    s_mov_b64 exec, s[16:17]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s6, v7, 1
; W64-O0-NEXT:    v_readlane_b32 s7, v7, 2
...
; W64-O0-NEXT:    v_readlane_b32 s12, v7, 0
; W64-O0-NEXT:    s_nop 4
...
; W64-O0-NEXT:    s_mov_b64 exec, s[16:17]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s6, v17, 1
; W64-O0-NEXT:    v_readlane_b32 s7, v17, 2
...
; W64-O0-NEXT:    v_readlane_b32 s12, v17, 0
; W64-O0-NEXT:    s_nop 4
; W64-O0-NEXT:    buffer_load_format_x v0, v0, s[8:11], s12 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
...
; W64-O0-NEXT:    s_mov_b64 exec, s[16:17]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s6, v17, 9
; W64-O0-NEXT:    v_readlane_b32 s7, v17, 10
...
; W64-O0-NEXT:    v_readlane_b32 s12, v13, 1
; W64-O0-NEXT:    s_nop 4
; W64-O0-NEXT:    buffer_load_format_x v0, v0, s[8:11], s12 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:68 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    s_mov_b64 exec, s[16:17]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s6, v13, 13
; W64-O0-NEXT:    v_readlane_b32 s7, v13, 14
...
; W64-O0-NEXT:    v_readlane_b32 s12, v13, 12
; W64-O0-NEXT:    s_nop 4
; W64-O0-NEXT:    buffer_load_format_x v0, v0, s[8:11], s12 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
