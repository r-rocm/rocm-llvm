...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x9
; GENERIC-NEXT:    s_load_dword s0, s[0:1], 0xb
...
; GENERIC-NEXT:    s_add_i32 s2, s0, 1
; GENERIC-NEXT:    s_cmp_eq_u32 s2, 1
; GENERIC-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e64 v13, 1.0, 2.0, s[0:1]
...
; SI-MOVREL-NEXT:    s_load_dword s4, s[0:1], 0xb
; SI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
...
; VI-MOVREL-NEXT:    s_load_dword s2, s[0:1], 0x2c
; VI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; VI-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0x2c
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GFX9-IDXMODE-NEXT:    s_load_dword s4, s[0:1], 0x2c
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
...
; GFX9-IDXMODE-NEXT:    global_store_dword v16, v0, s[2:3]
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dword s2, s[0:1], 0xb
; GENERIC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; GENERIC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dword s20, s[0:1], 0xb
; SI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; SI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; SI-MOVREL-NEXT:    s_mov_b32 s3, 0xf000
; SI-MOVREL-NEXT:    s_mov_b32 s2, -1
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dword s2, s[0:1], 0x2c
; VI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-MOVREL-NEXT:    s_add_i32 s2, s2, 1
...
; VI-MOVREL-NEXT:    s_or_b32 s3, s19, 16
; VI-MOVREL-NEXT:    s_or_b32 s18, s18, 15
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0x2c
; VI-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; VI-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; VI-IDXMODE-NEXT:    s_add_i32 s2, s2, 1
...
; VI-IDXMODE-NEXT:    s_or_b32 s3, s19, 16
; VI-IDXMODE-NEXT:    s_or_b32 s18, s18, 15
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dword s20, s[0:1], 0x2c
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    s_add_i32 s20, s20, 1
; GFX9-IDXMODE-NEXT:    s_or_b32 s4, s4, 1
; GFX9-IDXMODE-NEXT:    s_or_b32 s0, s19, 16
; GFX9-IDXMODE-NEXT:    s_or_b32 s1, s18, 15
...
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v14, s1
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v15, s0
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x9
; SI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0xb
; SI-MOVREL-NEXT:    v_mov_b32_e32 v0, 1.0
...
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; VI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0x2c
; VI-MOVREL-NEXT:    v_mov_b32_e32 v0, 1.0
; VI-MOVREL-NEXT:    v_mov_b32_e32 v1, 2.0
; VI-MOVREL-NEXT:    v_mov_b32_e32 v2, 0x40400000
; VI-MOVREL-NEXT:    v_mov_b32_e32 v3, 4.0
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; VI-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0x2c
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v0, 1.0
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v1, 2.0
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v2, 0x40400000
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v3, 4.0
...
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-MOVREL-NEXT:    s_add_i32 m0, s0, 0xfffffe00
...
; VI-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; VI-IDXMODE-NEXT:    s_addk_i32 s0, 0xfe00
...
; GFX9-IDXMODE-NEXT:    s_set_gpr_idx_off
; GFX9-IDXMODE-NEXT:    global_store_dword v0, v1, s[2:3]
; GFX9-IDXMODE-NEXT:    s_endpgm
entry:
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; GENERIC-NEXT:    s_load_dword s2, s[0:1], 0x39
; GENERIC-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0x29
; GENERIC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_addk_i32 s2, 0xfe00
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; SI-MOVREL-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0x29
; SI-MOVREL-NEXT:    s_load_dwordx2 s[20:21], s[0:1], 0x9
; SI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0x39
; SI-MOVREL-NEXT:    s_mov_b32 s23, 0xf000
; SI-MOVREL-NEXT:    s_mov_b32 s22, -1
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-MOVREL-NEXT:    s_or_b32 s4, s4, s36
; SI-MOVREL-NEXT:    s_or_b32 s1, s19, s51
; SI-MOVREL-NEXT:    s_or_b32 s2, s18, s50
; SI-MOVREL-NEXT:    s_or_b32 s3, s17, s49
...
; SI-MOVREL-NEXT:    v_mov_b32_e32 v11, s15
; SI-MOVREL-NEXT:    v_mov_b32_e32 v12, s16
; SI-MOVREL-NEXT:    v_mov_b32_e32 v13, s3
; SI-MOVREL-NEXT:    v_mov_b32_e32 v14, s2
; SI-MOVREL-NEXT:    v_mov_b32_e32 v15, s1
; SI-MOVREL-NEXT:    v_movrels_b32_e32 v0, v0
; SI-MOVREL-NEXT:    buffer_store_dword v0, off, s[20:23], 0
; SI-MOVREL-NEXT:    s_endpgm
;
; VI-MOVREL-LABEL: extract_neg_offset_sgpr_loaded:
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-MOVREL-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0xa4
; VI-MOVREL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; VI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0xe4
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-MOVREL-NEXT:    s_or_b32 s6, s6, s38
; VI-MOVREL-NEXT:    s_or_b32 s5, s5, s37
; VI-MOVREL-NEXT:    s_or_b32 s4, s4, s36
; VI-MOVREL-NEXT:    s_or_b32 s1, s19, s51
...
; VI-MOVREL-NEXT:    v_mov_b32_e32 v13, s17
; VI-MOVREL-NEXT:    v_mov_b32_e32 v14, s18
; VI-MOVREL-NEXT:    v_mov_b32_e32 v15, s1
; VI-MOVREL-NEXT:    v_movrels_b32_e32 v2, v0
; VI-MOVREL-NEXT:    v_mov_b32_e32 v0, s2
; VI-MOVREL-NEXT:    v_mov_b32_e32 v1, s3
; VI-MOVREL-NEXT:    flat_store_dword v[0:1], v2
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-IDXMODE-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0xa4
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; VI-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0xe4
; VI-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; VI-IDXMODE-NEXT:    s_or_b32 s6, s6, s38
; VI-IDXMODE-NEXT:    s_or_b32 s5, s5, s37
; VI-IDXMODE-NEXT:    s_or_b32 s4, s4, s36
; VI-IDXMODE-NEXT:    s_or_b32 s1, s19, s51
...
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v13, s17
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v14, s18
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v15, s1
; VI-IDXMODE-NEXT:    s_set_gpr_idx_on s0, gpr_idx(SRC0)
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v2, v0
; VI-IDXMODE-NEXT:    s_set_gpr_idx_off
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0xa4
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    s_load_dword s20, s[0:1], 0xe4
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    s_or_b32 s4, s4, s36
; GFX9-IDXMODE-NEXT:    s_or_b32 s0, s19, s51
; GFX9-IDXMODE-NEXT:    s_or_b32 s1, s18, s50
...
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx4 s[0:3], s[0:1], 0x9
; GENERIC-NEXT:    s_mov_b32 s7, 0xf000
; GENERIC-NEXT:    s_mov_b32 s6, -1
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx4 s[0:3], s[0:1], 0x9
; SI-MOVREL-NEXT:    s_mov_b32 s7, 0xf000
; SI-MOVREL-NEXT:    s_mov_b32 s6, -1
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx4 s[0:3], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_add_i32 s0, s0, 1
...
; GENERIC-NEXT:    s_cmp_eq_u32 s0, 0
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GFX9-IDXMODE-NEXT:    s_set_gpr_idx_off
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v16, v[12:15], s[2:3] offset:48
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v16, v[8:11], s[2:3] offset:32
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v16, v[4:7], s[2:3] offset:16
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v16, v[0:3], s[2:3]
; GFX9-IDXMODE-NEXT:    s_endpgm
entry:
  %add = add i32 %in, 1
...
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v1, 2.0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    s_and_b32 s0, s4, 0xffff
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v2, 0x40400000
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v3, 4.0
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v4, 0x40a00000
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v5, 0x40c00000
...
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v1, 2.0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    s_sext_i32_i16 s0, s4
; GFX9-IDXMODE-NEXT:    s_add_i32 s0, s0, 1
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v2, 0x40400000
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v3, 4.0
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v4, 0x40a00000
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v5, 0x40c00000
...
; SI-MOVREL-NEXT:    s_mov_b32 s6, -1
; SI-MOVREL-NEXT:    v_movreld_b32_e32 v0, v16
; SI-MOVREL-NEXT:    buffer_store_dwordx4 v[12:15], off, s[4:7], 0 offset:48
; SI-MOVREL-NEXT:    buffer_store_dwordx4 v[8:11], off, s[4:7], 0 offset:32
; SI-MOVREL-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:16
; SI-MOVREL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; SI-MOVREL-NEXT:    s_endpgm
;
...
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-MOVREL-NEXT:    s_mov_b32 m0, s0
; VI-MOVREL-NEXT:    s_add_u32 s0, s2, 48
; VI-MOVREL-NEXT:    v_mov_b32_e32 v4, 0x40a00000
; VI-MOVREL-NEXT:    v_mov_b32_e32 v5, 0x40c00000
; VI-MOVREL-NEXT:    v_mov_b32_e32 v6, 0x40e00000
; VI-MOVREL-NEXT:    v_mov_b32_e32 v7, 0x41000000
...
; VI-MOVREL-NEXT:    v_mov_b32_e32 v15, 0x41800000
; VI-MOVREL-NEXT:    v_mov_b32_e32 v16, 0x41880000
; VI-MOVREL-NEXT:    s_addc_u32 s1, s3, 0
; VI-MOVREL-NEXT:    v_movreld_b32_e32 v0, v16
; VI-MOVREL-NEXT:    v_mov_b32_e32 v17, s1
; VI-MOVREL-NEXT:    v_mov_b32_e32 v16, s0
; VI-MOVREL-NEXT:    s_add_u32 s0, s2, 32
; VI-MOVREL-NEXT:    s_addc_u32 s1, s3, 0
; VI-MOVREL-NEXT:    flat_store_dwordx4 v[16:17], v[12:15]
; VI-MOVREL-NEXT:    s_nop 0
; VI-MOVREL-NEXT:    v_mov_b32_e32 v13, s1
; VI-MOVREL-NEXT:    v_mov_b32_e32 v12, s0
; VI-MOVREL-NEXT:    s_add_u32 s0, s2, 16
; VI-MOVREL-NEXT:    s_addc_u32 s1, s3, 0
; VI-MOVREL-NEXT:    flat_store_dwordx4 v[12:13], v[8:11]
; VI-MOVREL-NEXT:    s_nop 0
...
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v0, v16
; VI-IDXMODE-NEXT:    s_set_gpr_idx_off
; VI-IDXMODE-NEXT:    s_add_u32 s0, s2, 48
; VI-IDXMODE-NEXT:    s_addc_u32 s1, s3, 0
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v17, s1
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v16, s0
; VI-IDXMODE-NEXT:    s_add_u32 s0, s2, 32
; VI-IDXMODE-NEXT:    s_addc_u32 s1, s3, 0
; VI-IDXMODE-NEXT:    flat_store_dwordx4 v[16:17], v[12:15]
; VI-IDXMODE-NEXT:    s_nop 0
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v13, s1
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v12, s0
; VI-IDXMODE-NEXT:    s_add_u32 s0, s2, 16
; VI-IDXMODE-NEXT:    s_addc_u32 s1, s3, 0
; VI-IDXMODE-NEXT:    flat_store_dwordx4 v[12:13], v[8:11]
; VI-IDXMODE-NEXT:    s_nop 0
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dword s4, s[0:1], 0xd
; GENERIC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xb
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
; GENERIC-NEXT:    s_mov_b32 s2, -1
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0xb
; SI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0xd
; SI-MOVREL-NEXT:    v_mov_b32_e32 v0, 0
; SI-MOVREL-NEXT:    v_mov_b32_e32 v1, 1
; SI-MOVREL-NEXT:    v_mov_b32_e32 v2, 2
; SI-MOVREL-NEXT:    v_mov_b32_e32 v3, 3
...
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x2c
; VI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0x34
; VI-MOVREL-NEXT:    v_mov_b32_e32 v0, 0
; VI-MOVREL-NEXT:    v_mov_b32_e32 v1, 1
; VI-MOVREL-NEXT:    v_mov_b32_e32 v2, 2
; VI-MOVREL-NEXT:    v_mov_b32_e32 v3, 3
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x2c
; VI-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0x34
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v0, 0
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v1, 1
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v2, 2
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v3, 3
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x2c
; GFX9-IDXMODE-NEXT:    s_load_dword s4, s[0:1], 0x34
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v1, 1
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v2, 2
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v3, 3
...
; GFX9-IDXMODE-NEXT:    s_set_gpr_idx_off
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v0, v[13:16], s[2:3] offset:48
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v0, v[9:12], s[2:3] offset:32
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v0, v[5:8], s[2:3] offset:16
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v0, v[1:4], s[2:3]
; GFX9-IDXMODE-NEXT:    s_endpgm
entry:
  %index = add i32 %offset, -512
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[16:17], s[0:1], 0xb
; GENERIC-NEXT:    s_load_dword s20, s[0:1], 0x29
; GENERIC-NEXT:    s_load_dwordx16 s[0:15], s[0:1], 0x19
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; SI-MOVREL-NEXT:    s_load_dword s20, s[0:1], 0x29
; SI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xb
; SI-MOVREL-NEXT:    s_mov_b32 s3, 0xf000
; SI-MOVREL-NEXT:    s_mov_b32 s2, -1
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-MOVREL-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-MOVREL-NEXT:    s_load_dword s2, s[0:1], 0xa4
; VI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x2c
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-MOVREL-NEXT:    v_mov_b32_e32 v0, s4
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VI-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0xa4
; VI-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x2c
; VI-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; VI-IDXMODE-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GFX9-IDXMODE-NEXT:    s_load_dword s20, s[0:1], 0xa4
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x2c
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x2c
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0xd
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0xd
; SI-MOVREL-NEXT:    s_load_dwordx2 s[8:9], s[0:1], 0x9
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
; GFX9-IDXMODE-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GFX9-IDXMODE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    global_load_dword v2, v1, s[2:3] glc
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v1, 0
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[20:21], s[0:1], 0xd
; GENERIC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
; GENERIC-NEXT:    s_mov_b32 s22, 0
; GENERIC-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GENERIC-NEXT:    v_mov_b32_e32 v2, 0
; GENERIC-NEXT:    s_mov_b32 s23, s3
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    buffer_load_dword v2, v[1:2], s[20:23], 0 addr64 glc
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; GENERIC-NEXT:    s_mov_b32 s2, -1
; GENERIC-NEXT:    ;;#ASMSTART
...
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-IDXMODE-NEXT:    global_load_dword v3, v1, s[2:3] glc
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    ;;#ASMSTART
...
; GFX9-IDXMODE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v2, v[15:18], s[2:3] offset:48
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v2, v[11:14], s[2:3] offset:32
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v2, v[7:10], s[2:3] offset:16
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    global_store_dwordx4 v2, v[3:6], s[2:3]
; GFX9-IDXMODE-NEXT:    s_waitcnt vmcnt(0)
; GFX9-IDXMODE-NEXT:    s_and_saveexec_b64 s[0:1], vcc
...
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_add_i32 s1, s0, 1
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 12
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 13
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v1, v1, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 14
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v2, v2, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 15
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v3, v3, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 8
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v4, v4, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 9
; GENERIC-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v5, v5, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 10
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v6, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 11
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v7, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 4
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v9, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 5
; GENERIC-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:32
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v10, v10, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 6
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v11, v11, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 7
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v12, v12, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 0
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v13, 1.0, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 1
; GENERIC-NEXT:    buffer_store_dwordx4 v[9:12], off, s[4:7], 0 offset:16
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v14, 2.0, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 2
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v15, v15, v8, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s1, 3
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v16, 4.0, v8, vcc
; GENERIC-NEXT:    s_add_i32 s0, s0, 2
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 3
; GENERIC-NEXT:    buffer_store_dwordx4 v[13:16], off, s[4:7], 0
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_cndmask_b32_e32 v16, v8, v16, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 2
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 7
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v12, v8, v12, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 6
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v11, v8, v11, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 5
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v10, v8, v10, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 4
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v8, v9, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 11
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v8, v7, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 10
; GENERIC-NEXT:    buffer_store_dwordx4 v[9:12], off, s[4:7], 0 offset:80
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v8, v6, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 9
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v5, v8, v5, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 8
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v4, v8, v4, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 15
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v3, v8, v3, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 14
; GENERIC-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:96
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v2, v8, v2, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 13
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v1, v8, v1, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 12
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; GENERIC-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:112
; GENERIC-NEXT:    buffer_store_dwordx4 v[13:16], off, s[4:7], 0 offset:64
; GENERIC-NEXT:    s_endpgm
;
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dword s2, s[0:1], 0xb
; SI-MOVREL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; SI-MOVREL-NEXT:    v_mov_b32_e32 v0, 1.0
; SI-MOVREL-NEXT:    v_mov_b32_e32 v1, 2.0
; SI-MOVREL-NEXT:    v_mov_b32_e32 v2, 0x40400000
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0x2c
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v1, 2.0
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v2, 0x40400000
...
; GENERIC:       ; %bb.0: ; %bb
; GENERIC-NEXT:    s_load_dword s0, s[0:1], 0x9
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 0
...
; SI-MOVREL:       ; %bb.0: ; %bb
; SI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0x9
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-MOVREL:       ; %bb.0: ; %bb
; VI-MOVREL-NEXT:    s_load_dword s0, s[0:1], 0x24
...
; VI-IDXMODE:       ; %bb.0: ; %bb
; VI-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0x24
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x9
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
; GENERIC-NEXT:    s_mov_b32 s2, -1
; GENERIC-NEXT:    s_load_dword s12, s[0:1], 0xd
; GENERIC-NEXT:    s_mov_b32 s10, s2
; GENERIC-NEXT:    s_mov_b32 s11, s3
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_mov_b32 s0, s4
; GENERIC-NEXT:    s_mov_b32 s1, s5
; GENERIC-NEXT:    s_mov_b32 s8, s6
; GENERIC-NEXT:    s_mov_b32 s9, s7
...
; SI-MOVREL:       ; %bb.0: ; %entry
; SI-MOVREL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x9
; SI-MOVREL-NEXT:    s_load_dword s12, s[0:1], 0xd
; SI-MOVREL-NEXT:    s_mov_b32 s3, 0xf000
; SI-MOVREL-NEXT:    s_mov_b32 s2, -1
; SI-MOVREL-NEXT:    s_mov_b32 s10, s2
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-MOVREL-NEXT:    s_mov_b32 s8, s6
; SI-MOVREL-NEXT:    s_mov_b32 s9, s7
...
; VI-MOVREL:       ; %bb.0: ; %entry
; VI-MOVREL-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; VI-MOVREL-NEXT:    s_load_dword s2, s[0:1], 0x34
; VI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-IDXMODE:       ; %bb.0: ; %entry
; VI-IDXMODE-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; VI-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0x34
; VI-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-IDXMODE:       ; %bb.0: ; %entry
; GFX9-IDXMODE-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x24
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-IDXMODE-NEXT:    s_load_dword s0, s[0:1], 0x34
; GFX9-IDXMODE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GENERIC:       ; %bb.0:
; GENERIC-NEXT:    s_load_dwordx2 s[20:21], s[0:1], 0x9
; GENERIC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x19
; GENERIC-NEXT:    s_load_dword s0, s[0:1], 0x29
...
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 10
; GENERIC-NEXT:    buffer_store_dwordx4 v[4:7], off, s[20:23], 0 offset:16
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
...
; GENERIC-NEXT:    s_cmp_lg_u32 s0, 14
; GENERIC-NEXT:    buffer_store_dwordx4 v[5:8], off, s[20:23], 0 offset:32
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
...
; GENERIC-NEXT:    buffer_store_dwordx4 v[6:9], off, s[20:23], 0 offset:48
; GENERIC-NEXT:    buffer_store_dwordx4 v[0:3], off, s[20:23], 0
; GENERIC-NEXT:    s_endpgm
;
...
; SI-MOVREL-NEXT:    s_mov_b32 s3, 0xf000
; SI-MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-MOVREL-NEXT:    s_lshl_b32 s20, s20, 2
; SI-MOVREL-NEXT:    v_mov_b32_e32 v0, s4
; SI-MOVREL-NEXT:    v_mov_b32_e32 v1, s5
; SI-MOVREL-NEXT:    v_mov_b32_e32 v2, s6
; SI-MOVREL-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX9-IDXMODE:       ; %bb.0:
; GFX9-IDXMODE-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GFX9-IDXMODE-NEXT:    s_load_dword s2, s[0:1], 0xa4
; GFX9-IDXMODE-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-IDXMODE-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
