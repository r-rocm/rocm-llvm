...
; GFX900-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX900-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX900-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX900-NEXT:    ; kill: def $sgpr4_sgpr5 killed $exec
; GFX900-NEXT:    s_cmov_b64 exec, vcc
...
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX908-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX908-NEXT:    ; kill: def $sgpr4_sgpr5 killed $exec
; GFX908-NEXT:    s_cmov_b64 exec, vcc
...
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX90A-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX90A-NEXT:    ; kill: def $sgpr4_sgpr5 killed $exec
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
...
; GFX10-NEXT:    ; kill: def $sgpr2 killed $exec_lo
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-NEXT:    ; kill: def $sgpr3 killed $exec_lo
...
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GCN-NEXT:    s_cmp_lg_u64 vcc, 0
; GCN-NEXT:    ; kill: def $sgpr4_sgpr5 killed $exec
; GCN-NEXT:    s_cmov_b64 exec, vcc
...
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX11-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX11-NEXT:    ; kill: def $sgpr4_sgpr5 killed $exec
; GFX11-NEXT:    s_cmov_b64 exec, vcc
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s3, exec_lo
; GFX11-NEXT:    ; kill: def $sgpr2 killed $exec_lo
...
; GFX900-NEXT:    s_andn2_b64 s[6:7], exec, s[0:1]
; GFX900-NEXT:    s_cselect_b64 exec, s[6:7], s[0:1]
...
; GFX908-NEXT:    s_andn2_b64 s[6:7], exec, s[0:1]
; GFX908-NEXT:    s_cselect_b64 exec, s[6:7], s[0:1]
...
; GFX90A-NEXT:    s_andn2_b64 s[6:7], exec, s[0:1]
; GFX90A-NEXT:    s_cselect_b64 exec, s[6:7], s[0:1]
