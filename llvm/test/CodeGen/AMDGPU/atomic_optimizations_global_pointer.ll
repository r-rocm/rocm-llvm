...
; GFX1032_ITERATIVE-NEXT:    s_xor_b32 s5, vcc_lo, exec_lo
...
; GFX1064_DPP-NEXT:    s_mov_b32 s4, s7
...
; GFX1164_DPP-NEXT:    s_mov_b32 s4, s7
...
; GFX1264_DPP-NEXT:    s_mov_b32 s4, s7
...
; GFX9_ITERATIVE-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX9_ITERATIVE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX9_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX9_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX1064_ITERATIVE-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1064_ITERATIVE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1064_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX1064_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
...
; GFX1032_ITERATIVE-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1032_ITERATIVE-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX1032_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
...
; GFX1164_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1164_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1164_DPP-NEXT:    v_readlane_b32 s10, v3, 31
; GFX1164_DPP-NEXT:    v_writelane_b32 v1, s6, 16
; GFX1164_DPP-NEXT:    v_readlane_b32 s11, v4, 31
...
; GFX1164_DPP-NEXT:    v_readlane_b32 s13, v4, 47
...
; GFX1132_DPP-NEXT:    v_readlane_b32 s9, v4, 15
...
; GFX1264_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1264_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1264_DPP-NEXT:    v_readlane_b32 s10, v3, 31
; GFX1264_DPP-NEXT:    v_writelane_b32 v1, s6, 16
; GFX1264_DPP-NEXT:    v_readlane_b32 s11, v4, 31
; GFX1264_DPP-NEXT:    v_writelane_b32 v2, s7, 16
; GFX1264_DPP-NEXT:    v_readlane_b32 s6, v3, 63
; GFX1264_DPP-NEXT:    v_readlane_b32 s12, v3, 47
; GFX1264_DPP-NEXT:    v_readlane_b32 s13, v4, 47
...
; GFX1232_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX1232_DPP-NEXT:    v_readlane_b32 s9, v4, 15
