...
; GCN-O0-NEXT:    v_cmp_gt_u32_e64 s[0:1], v0, s0
...
; GCN-O0-NEXT:    buffer_load_dword v4, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
...
; GCN-NEXT:    s_and_b64 s[0:1], s[2:3], -1
...
; GCN-NEXT:    buffer_store_dword v3, v[0:1], s[0:3], 0 addr64 offset:4
...
; GCN-O0-NEXT:    v_readlane_b32 s1, v4, 5
; GCN-O0-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
; GCN-O0-NEXT:    v_writelane_b32 v4, s2, 6
; GCN-O0-NEXT:    v_writelane_b32 v4, s3, 7
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[2:3], s[0:1], -1
...
; GCN-O0-NEXT:    v_mov_b32_e32 v1, v0
; GCN-O0-NEXT:    buffer_store_dword v1, off, s[12:15], 0 offset:16 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s0, 2
...
; GCN-O0-NEXT:    buffer_store_dword v4, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    buffer_store_dword v5, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
...
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    buffer_store_dword v6, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[2:3], s[0:1], -1
; GCN-O0-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v6, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s0, v6, 0
; GCN-O0-NEXT:    v_readlane_b32 s1, v6, 1
; GCN-O0-NEXT:    s_xor_b64 s[2:3], s[0:1], exec
; GCN-O0-NEXT:    v_writelane_b32 v6, s2, 2
; GCN-O0-NEXT:    v_writelane_b32 v6, s3, 3
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    buffer_store_dword v6, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[2:3], s[0:1], -1
...
; GCN-O0-NEXT:    buffer_load_dword v3, off, s[12:15], 0 offset:12 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    s_waitcnt expcnt(0)
; GCN-O0-NEXT:    buffer_load_dword v6, off, s[12:15], 0 offset:4 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
...
; GCN-O0-NEXT:    v_cmp_gt_u32_e64 s[0:1], v0, s0
; GCN-O0-NEXT:    s_mov_b64 s[2:3], exec
; GCN-O0-NEXT:    v_writelane_b32 v3, s2, 2
; GCN-O0-NEXT:    v_writelane_b32 v3, s3, 3
; GCN-O0-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN-O0-NEXT:    buffer_store_dword v3, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-O0-NEXT:    s_and_b64 s[2:3], s[0:1], -1
; GCN-O0-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GCN-O0-NEXT:    v_readlane_b32 s5, v3, 1
; GCN-O0-NEXT:    s_mov_b32 s6, 0xf000
; GCN-O0-NEXT:    s_mov_b32 s2, 0
; GCN-O0-NEXT:    ; kill: def $sgpr2 killed $sgpr2 def $sgpr2_sgpr3
; GCN-O0-NEXT:    s_mov_b32 s3, s6
...
; GCN-O0-NEXT:    v_writelane_b32 v6, s4, 4
; GCN-O0-NEXT:    v_writelane_b32 v6, s5, 5
; GCN-O0-NEXT:    s_mov_b32 s6, 0x207
; GCN-O0-NEXT:    v_cmp_lt_i32_e64 s[6:7], v0, s6
...
; GCN-O0-NEXT:    s_mov_b32 s4, 0
; GCN-O0-NEXT:    s_waitcnt vmcnt(1)
; GCN-O0-NEXT:    v_cmp_ne_u32_e64 s[6:7], v0, s4
; GCN-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, s4
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_writelane_b32 v6, s6, 6
; GCN-O0-NEXT:    v_writelane_b32 v6, s7, 7
; GCN-O0-NEXT:    s_mov_b32 s6, 0
...
; GCN-O0-NEXT:    v_writelane_b32 v6, s6, 8
; GCN-O0-NEXT:    v_writelane_b32 v6, s7, 9
; GCN-O0-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GCN-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[16:17]
...
; GCN-O0-NEXT:    s_mov_b32 s6, 0
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_cmp_lt_f32_e64 s[4:5], v0, s6
; GCN-O0-NEXT:    s_mov_b32 s8, s6
; GCN-O0-NEXT:    s_mov_b32 s9, s6
; GCN-O0-NEXT:    s_mov_b32 s10, s6
; GCN-O0-NEXT:    s_mov_b32 s11, s6
...
; GCN-O0-NEXT:    s_mov_b64 s[6:7], exec
; GCN-O0-NEXT:    v_writelane_b32 v6, s6, 10
; GCN-O0-NEXT:    v_writelane_b32 v6, s7, 11
; GCN-O0-NEXT:    s_or_saveexec_b64 s[16:17], -1
; GCN-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b64 exec, s[16:17]
; GCN-O0-NEXT:    s_and_b64 s[6:7], s[4:5], -1
...
; GCN-O0-NEXT:    s_mov_b64 exec, s[16:17]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    v_readlane_b32 s4, v6, 8
; GCN-O0-NEXT:    v_readlane_b32 s5, v6, 9
; GCN-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
; GCN-O0-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; GCN-O0-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
...
; GCN-O0-NEXT:    v_writelane_b32 v6, s6, 12
; GCN-O0-NEXT:    v_writelane_b32 v6, s7, 13
; GCN-O0-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GCN-O0-NEXT:    s_mov_b64 s[6:7], exec
; GCN-O0-NEXT:    v_writelane_b32 v6, s6, 14
; GCN-O0-NEXT:    v_writelane_b32 v6, s7, 15
