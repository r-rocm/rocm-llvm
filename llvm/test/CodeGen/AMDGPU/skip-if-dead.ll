...
; GFX10-WAVE64-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX10-WAVE32-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; SI-NEXT:  .LBB13_3: ; %bb4
; SI-NEXT:    ; kill: def $sgpr0_sgpr1 killed $exec
...
; GFX10-WAVE64-NEXT:    ; kill: def $sgpr0_sgpr1 killed $exec
...
; GFX10-WAVE32-NEXT:    ; kill: def $sgpr0 killed $exec_lo
...
; GFX11-NEXT:    ; kill: def $sgpr0_sgpr1 killed $exec
...
; GFX10-WAVE64-NEXT:    s_cmp_lg_u64 s[0:1], 0
...
; SI-NEXT:    s_cmov_b64 exec, vcc
; SI-NEXT:    s_cbranch_scc0 .LBB16_2
; SI-NEXT:  ; %bb.1: ; %bb.0
...
; GFX10-WAVE64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX10-WAVE64-NEXT:    s_mov_b64 s[4:5], exec
; GFX10-WAVE64-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX10-WAVE64-NEXT:    s_cmov_b64 exec, vcc
; GFX10-WAVE64-NEXT:    s_cbranch_scc0 .LBB16_2
