...
; CHECK-NEXT:    s_andn2_b32 s4, exec_lo, s43
; CHECK-NEXT:    s_cselect_b32 exec_lo, s4, s43
; CHECK-NEXT:    s_cbranch_scc0 .LBB0_24
...
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[6:7]
; CHECK-NEXT:    v_mov_b32_e32 v0, 0
; CHECK-NEXT:    ; kill: def $sgpr4 killed $exec_lo
...
; CHECK-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; CHECK-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; CHECK-NEXT:    s_cbranch_scc0 .LBB0_32
; CHECK-NEXT:  ; %bb.31: ; in Loop: Header=BB0_29 Depth=1
...
; CHECK-NEXT:  .LBB0_32: ; %Flow
; CHECK-NEXT:    ; in Loop: Header=BB0_29 Depth=1
; CHECK-NEXT:    s_xor_b32 s5, s4, exec_lo
; CHECK-NEXT:    s_cmp_lg_u32 s4, 0
; CHECK-NEXT:    s_cmov_b32 exec_lo, s4
; CHECK-NEXT:    s_cbranch_scc0 .LBB0_27
; CHECK-NEXT:  ; %bb.33: ; in Loop: Header=BB0_29 Depth=1
; CHECK-NEXT:    v_mov_b32_e32 v31, v40
; CHECK-NEXT:    v_mov_b32_e32 v0, v42
; CHECK-NEXT:    v_mov_b32_e32 v1, v43
; CHECK-NEXT:    v_mov_b32_e32 v2, v44
