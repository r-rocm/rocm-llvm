...
; MUBUF-NEXT:    ; kill: def $sgpr0 killed $exec_lo
; MUBUF-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; FLATSCR-NEXT:    ; kill: def $sgpr0 killed $exec_lo
; FLATSCR-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; MUBUF11-NEXT:    ; kill: def $sgpr0 killed $exec_lo
; MUBUF11-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; FLATSCR11-NEXT:    ; kill: def $sgpr0 killed $exec_lo
; FLATSCR11-NEXT:    s_cmp_lg_u32 vcc_lo, 0
