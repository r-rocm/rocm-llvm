...
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[48:49]
; GCN-NEXT:    s_cselect_b64 exec, s[4:5], s[46:47]
...
; GISEL-NEXT:    v_writelane_b32 v40, s16, 16
...
; GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; GISEL-NEXT:    s_cselect_b64 exec, s[4:5], s[46:47]
...
; GISEL-NEXT:    v_readlane_b32 s4, v40, 16
...
; GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[46:47]
; GISEL-NEXT:    s_cselect_b64 exec, s[4:5], s[46:47]
; GISEL-NEXT:    s_cbranch_scc1 .LBB3_1
; GISEL-NEXT:  ; %bb.2:
; GISEL-NEXT:    v_readlane_b32 s30, v40, 14
; GISEL-NEXT:    v_readlane_b32 s31, v40, 15
; GISEL-NEXT:    v_readlane_b32 s47, v40, 13
...
; GCN-NEXT:    s_cselect_b64 exec, s[4:5], s[48:49]
...
; GISEL-NEXT:  .LBB5_1: ; =>This Inner Loop Header: Depth=1
; GISEL-NEXT:    v_readfirstlane_b32 s16, v0
; GISEL-NEXT:    v_readfirstlane_b32 s17, v1
; GISEL-NEXT:    v_cmp_eq_u64_e32 vcc, s[16:17], v[0:1]
...
; GISEL-NEXT:    ; implicit-def: $vgpr0
; GISEL-NEXT:    ; implicit-def: $vgpr31
; GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[48:49]
; GISEL-NEXT:    s_cselect_b64 exec, s[4:5], s[48:49]
; GISEL-NEXT:    s_cbranch_scc1 .LBB5_1
; GISEL-NEXT:  ; %bb.2:
; GISEL-NEXT:    s_or_b64 exec, exec, s[46:47]
; GISEL-NEXT:  .LBB5_3: ; %bb2
...
; GISEL-NEXT:    ; implicit-def: $vgpr0
; GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[8:9]
; GISEL-NEXT:    s_cselect_b64 exec, s[4:5], s[8:9]
; GISEL-NEXT:    s_cbranch_scc1 .LBB6_1
; GISEL-NEXT:  ; %bb.2:
...
; GCN-NEXT:    v_writelane_b32 v41, s45, 11
; GCN-NEXT:    v_writelane_b32 v41, s46, 12
; GCN-NEXT:    v_writelane_b32 v41, s47, 13
; GCN-NEXT:    v_writelane_b32 v41, s48, 14
; GCN-NEXT:    v_writelane_b32 v41, s49, 15
; GCN-NEXT:    v_writelane_b32 v41, s50, 16
; GCN-NEXT:    v_writelane_b32 v41, s51, 17
; GCN-NEXT:    v_writelane_b32 v41, s52, 18
; GCN-NEXT:    v_writelane_b32 v41, s53, 19
; GCN-NEXT:    v_writelane_b32 v41, s54, 20
; GCN-NEXT:    v_writelane_b32 v41, s55, 21
; GCN-NEXT:    v_writelane_b32 v41, s56, 22
; GCN-NEXT:    v_writelane_b32 v41, s57, 23
; GCN-NEXT:    v_writelane_b32 v41, s58, 24
; GCN-NEXT:    v_writelane_b32 v41, s59, 25
; GCN-NEXT:    v_writelane_b32 v41, s60, 26
; GCN-NEXT:    v_writelane_b32 v41, s61, 27
; GCN-NEXT:    v_writelane_b32 v41, s62, 28
; GCN-NEXT:    v_writelane_b32 v41, s63, 29
; GCN-NEXT:    v_writelane_b32 v41, s30, 30
; GCN-NEXT:    v_writelane_b32 v41, s31, 31
...
; GCN-NEXT:  ; %bb.2:
; GCN-NEXT:    v_mov_b32_e32 v0, v40
; GCN-NEXT:    v_readlane_b32 s30, v41, 30
; GCN-NEXT:    v_readlane_b32 s31, v41, 31
; GCN-NEXT:    v_readlane_b32 s63, v41, 29
; GCN-NEXT:    v_readlane_b32 s62, v41, 28
; GCN-NEXT:    v_readlane_b32 s61, v41, 27
; GCN-NEXT:    v_readlane_b32 s60, v41, 26
; GCN-NEXT:    v_readlane_b32 s59, v41, 25
; GCN-NEXT:    v_readlane_b32 s58, v41, 24
; GCN-NEXT:    v_readlane_b32 s57, v41, 23
; GCN-NEXT:    v_readlane_b32 s56, v41, 22
; GCN-NEXT:    v_readlane_b32 s55, v41, 21
; GCN-NEXT:    v_readlane_b32 s54, v41, 20
; GCN-NEXT:    v_readlane_b32 s53, v41, 19
; GCN-NEXT:    v_readlane_b32 s52, v41, 18
; GCN-NEXT:    v_readlane_b32 s51, v41, 17
; GCN-NEXT:    v_readlane_b32 s50, v41, 16
; GCN-NEXT:    v_readlane_b32 s49, v41, 15
; GCN-NEXT:    v_readlane_b32 s48, v41, 14
; GCN-NEXT:    v_readlane_b32 s47, v41, 13
; GCN-NEXT:    v_readlane_b32 s46, v41, 12
; GCN-NEXT:    v_readlane_b32 s45, v41, 11
; GCN-NEXT:    v_readlane_b32 s44, v41, 10
; GCN-NEXT:    v_readlane_b32 s43, v41, 9
; GCN-NEXT:    v_readlane_b32 s42, v41, 8
; GCN-NEXT:    v_readlane_b32 s41, v41, 7
; GCN-NEXT:    v_readlane_b32 s40, v41, 6
...
; GISEL-NEXT:    v_writelane_b32 v41, s40, 6
; GISEL-NEXT:    v_writelane_b32 v41, s41, 7
; GISEL-NEXT:    v_writelane_b32 v41, s42, 8
; GISEL-NEXT:    v_writelane_b32 v41, s43, 9
; GISEL-NEXT:    v_writelane_b32 v41, s44, 10
; GISEL-NEXT:    v_writelane_b32 v41, s45, 11
; GISEL-NEXT:    v_writelane_b32 v41, s46, 12
; GISEL-NEXT:    v_writelane_b32 v41, s47, 13
; GISEL-NEXT:    v_writelane_b32 v41, s48, 14
; GISEL-NEXT:    v_writelane_b32 v41, s49, 15
; GISEL-NEXT:    v_writelane_b32 v41, s50, 16
; GISEL-NEXT:    v_writelane_b32 v41, s51, 17
; GISEL-NEXT:    v_writelane_b32 v41, s52, 18
; GISEL-NEXT:    v_writelane_b32 v41, s53, 19
; GISEL-NEXT:    v_writelane_b32 v41, s54, 20
; GISEL-NEXT:    v_writelane_b32 v41, s55, 21
; GISEL-NEXT:    v_writelane_b32 v41, s56, 22
; GISEL-NEXT:    v_writelane_b32 v41, s57, 23
; GISEL-NEXT:    v_writelane_b32 v41, s58, 24
; GISEL-NEXT:    v_writelane_b32 v41, s59, 25
; GISEL-NEXT:    v_writelane_b32 v41, s60, 26
; GISEL-NEXT:    v_writelane_b32 v41, s61, 27
; GISEL-NEXT:    v_writelane_b32 v41, s62, 28
; GISEL-NEXT:    v_writelane_b32 v41, s63, 29
; GISEL-NEXT:    v_writelane_b32 v41, s30, 30
; GISEL-NEXT:    v_writelane_b32 v41, s31, 31
...
; GISEL-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GISEL-NEXT:    s_cbranch_scc1 .LBB7_1
; GISEL-NEXT:  ; %bb.2:
; GISEL-NEXT:    v_mov_b32_e32 v0, v40
; GISEL-NEXT:    v_readlane_b32 s30, v41, 30
; GISEL-NEXT:    v_readlane_b32 s31, v41, 31
; GISEL-NEXT:    v_readlane_b32 s63, v41, 29
; GISEL-NEXT:    v_readlane_b32 s62, v41, 28
; GISEL-NEXT:    v_readlane_b32 s61, v41, 27
; GISEL-NEXT:    v_readlane_b32 s60, v41, 26
; GISEL-NEXT:    v_readlane_b32 s59, v41, 25
; GISEL-NEXT:    v_readlane_b32 s58, v41, 24
; GISEL-NEXT:    v_readlane_b32 s57, v41, 23
; GISEL-NEXT:    v_readlane_b32 s56, v41, 22
; GISEL-NEXT:    v_readlane_b32 s55, v41, 21
; GISEL-NEXT:    v_readlane_b32 s54, v41, 20
; GISEL-NEXT:    v_readlane_b32 s53, v41, 19
; GISEL-NEXT:    v_readlane_b32 s52, v41, 18
; GISEL-NEXT:    v_readlane_b32 s51, v41, 17
; GISEL-NEXT:    v_readlane_b32 s50, v41, 16
; GISEL-NEXT:    v_readlane_b32 s49, v41, 15
; GISEL-NEXT:    v_readlane_b32 s48, v41, 14
; GISEL-NEXT:    v_readlane_b32 s47, v41, 13
; GISEL-NEXT:    v_readlane_b32 s46, v41, 12
; GISEL-NEXT:    v_readlane_b32 s45, v41, 11
; GISEL-NEXT:    v_readlane_b32 s44, v41, 10
; GISEL-NEXT:    v_readlane_b32 s43, v41, 9
; GISEL-NEXT:    v_readlane_b32 s42, v41, 8
; GISEL-NEXT:    v_readlane_b32 s41, v41, 7
; GISEL-NEXT:    v_readlane_b32 s40, v41, 6
...
; GISEL-NEXT:    s_cbranch_scc1 .LBB8_1
; GISEL-NEXT:  ; %bb.2:
