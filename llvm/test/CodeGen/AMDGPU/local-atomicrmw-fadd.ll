...
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_ff1_i32_b64 s5, s[2:3]
; GFX7-NEXT:    s_lshl_b64 s[6:7], 1, s5
; GFX7-NEXT:    s_andn2_b64 s[2:3], s[2:3], s[6:7]
; GFX7-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[2:3], 0
...
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], v2, v4
; GFX7-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
; GFX7-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[2:3], v2, v4
; GFX6-NEXT:    s_or_b64 s[4:5], s[2:3], s[4:5]
; GFX6-NEXT:    s_andn2_b64 exec, exec, s[4:5]
