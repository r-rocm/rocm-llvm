...
define amdgpu_ps float @simple_test_return_to_epilog(float %a) #0 {
  ...
  ; GCN: bb.0.entry:
  ; GCN:   liveins: $vgpr0
  ; GCN:   frame-setup CFI_INSTRUCTION escape 0x0f, 0x04, 0x30, 0x36, 0xe9, 0x02
...
define amdgpu_ps { <4 x float> } @test_return_to_epilog_with_optimized_kill(float %val) #0 {
  ...
  ; GCN:   renamable $sgpr2_sgpr3 = S_XOR_B64 renamable $vcc, $exec, implicit-def $scc
  ; GCN:   S_CMP_LG_U64 renamable $vcc, 0, implicit-def $scc
  ; GCN:   $exec = S_CMOV_B64 killed renamable $vcc, implicit $scc
  ; GCN:   S_CBRANCH_SCC0 %bb.4, implicit killed $scc
  ...
  ; GCN:   renamable $sgpr6_sgpr7 = S_ANDN2_B64 $exec, renamable $sgpr4_sgpr5, implicit-def $scc
  ; GCN:   $exec = S_CSELECT_B64 killed renamable $sgpr6_sgpr7, renamable $sgpr4_sgpr5, implicit $scc
  ; GCN:   S_CBRANCH_SCC1 %bb.2, implicit killed $scc
  ; GCN: bb.3.Flow:
  ; GCN:   successors: %bb.4(0x80000000)
  ; GCN:   liveins: $sgpr0_sgpr1, $sgpr2_sgpr3
  ; GCN:   $exec = S_OR_B64 $exec, renamable $sgpr2_sgpr3, implicit-def $scc
  ; GCN: bb.4.Flow1:
  ; GCN:   successors: %bb.5(0x40000000), %bb.7(0x40000000)
  ; GCN:   liveins: $sgpr0_sgpr1, $sgpr2_sgpr3
  ; GCN:   renamable $sgpr4_sgpr5 = S_XOR_B64 renamable $sgpr2_sgpr3, $exec, implicit-def $scc
  ; GCN:   S_CMP_LG_U64 renamable $sgpr2_sgpr3, 0, implicit-def $scc
  ; GCN:   $exec = S_CMOV_B64 killed renamable $sgpr2_sgpr3, implicit $scc
  ; GCN:   S_CBRANCH_SCC0 %bb.7, implicit killed $scc
  ; GCN: bb.5.kill0:
  ; GCN:   successors: %bb.6(0x40000000), %bb.8(0x40000000)
  ; GCN:   liveins: $sgpr0_sgpr1, $sgpr4_sgpr5
