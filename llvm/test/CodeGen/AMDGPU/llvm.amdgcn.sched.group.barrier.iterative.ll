...
; GCN-MINREG-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
...
; GCN-MAXOCC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GCN-MAXOCC-NEXT:    v_lshlrev_b32_e32 v33, 7, v0
...
; GCN-ILP:       ; %bb.0: ; %entry
; GCN-ILP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GCN-ILP-NEXT:    v_lshlrev_b32_e32 v32, 7, v0
...
; GCN-MAXOCC:       ; %bb.0: ; %entry
; GCN-MAXOCC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GCN-MAXOCC-NEXT:    v_lshlrev_b32_e32 v35, 7, v0
...
; GCN-ILP:       ; %bb.0: ; %entry
; GCN-ILP-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; GCN-ILP-NEXT:    v_lshlrev_b32_e32 v34, 7, v0
